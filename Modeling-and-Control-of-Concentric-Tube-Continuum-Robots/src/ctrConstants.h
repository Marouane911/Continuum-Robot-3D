...
namespace CtrLib{
    ...
    constexpr int NB_INTEGRATION_NODES = 4;               // number of integration nodes per segment (Increasing this value, e.g to 5, yield smoother shaper in the 3d plot, but at the cost of slower computation)
